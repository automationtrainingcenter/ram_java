...
public class VariablesDemo {
	...
	public static void main(String[] args) {
		...
		int x; // declaration
		x = 99; // assigning
		int y = 76; // Initialisation
		
		// retrieve the local variable values
		...
		// retrieve the instance variable values
		System.out.println("iVar value is "+obj.iVar);
		
		// assign a value to the static variable
		VariablesDemo.sVar = 122;
		
		// retrieve the static variable values
		System.out.println("sVar value is "+VariablesDemo.sVar);
